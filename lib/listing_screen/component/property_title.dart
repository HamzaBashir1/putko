...
class PropertyTitle extends StatefulWidget {
  ...
  const PropertyTitle({super.key, required this.postingId});
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    if (_titleController.text.isNotEmpty) {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => TitleDescribe(postingId: widget.postingId)),
                      );
                    } else {
